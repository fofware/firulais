export default {
  ...
  mongoDB:{
//    URI: process.env.MONGODB_URI || 'mongodb://firulais.net.ar:27044/gestion',
//    URI: process.env.MONGODB_URI || 'mongodb://192.168.100.150:27044/gestion',
    URI: process.env.MONGODB_URI || 'mongodb://192.168.100.150:27084/gestion',
